...
const Main = ({ children, router }) => {
  return (
    ...
    <meta name="description" content="Web developer passionate about science fiction, photography, comics, video games, death metal, and 3D printing. Visit my GitHub to see my work."/>
